...
const en = {
  ...
  'stage.2-1.subtitle': 'Thornwake Steps', 'stage.2-2.subtitle': 'Vine Ferry', 'stage.2-3.subtitle': 'Bramble Run',
  'stage.2-4.subtitle': 'Canopy Lift', 'stage.2-5.subtitle': 'Sanctuary Gauntlet', 'stage.2-6.subtitle': 'Heartroot Duel',
  'stage.3-1.subtitle': 'Tide Inversion', 'stage.3-2.subtitle': 'Undertide Steps', 'stage.3-3.subtitle': 'Mirror Current',
  'stage.3-4.subtitle': 'Pearl Vortex', 'stage.3-5.subtitle': 'Abyss Current', 'stage.3-6.subtitle': 'Leviathan Mirror',
  'stage.4-1.subtitle': 'Icebound Run', 'stage.4-2.subtitle': 'Crystal Slope', 'stage.4-3.subtitle': 'Frost Chain',
  'stage.4-4.subtitle': 'Blizzard Lifts', 'stage.4-5.subtitle': 'Frozen Gauntlet', 'stage.4-6.subtitle': 'Snowcrown Duel',
  'stage.5-1.subtitle': 'Cinder Run', 'stage.5-2.subtitle': 'Magma Lift', 'stage.5-3.subtitle': 'Eruption Chain',
  'stage.5-4.subtitle': 'Caldera Crossing', 'stage.5-5.subtitle': 'Inferno Gauntlet', 'stage.5-6.subtitle': 'Emberheart Duel',
  'stage.6-1.subtitle': 'Hollow Threshold', 'stage.6-2.subtitle': 'Inverted Thorns', 'stage.6-3.subtitle': 'Abyssal Conveyor',
  'stage.6-4.subtitle': 'Demon Current', 'stage.6-5.subtitle': 'Final Synthesis', 'stage.6-6.subtitle': 'Abyss Queen Duel',
  ...
  'hud.bossPhase': 'Boss Phase', 'hud.bossPhaseHint': 'Each hit starts the next pattern from the entrance.',
...
const ja: Dictionary = {
  ...
  'stage.1-5.subtitle': '空中庭園', 'stage.1-6.subtitle': '高き尖塔', 'stage.2-1.subtitle': '棘醒めの階段',
  'stage.2-2.subtitle': '蔦の渡し', 'stage.2-3.subtitle': '茨の疾走', 'stage.2-4.subtitle': '樹冠リフト',
  'stage.2-5.subtitle': '聖域の試練', 'stage.2-6.subtitle': '心根の決闘',
  'stage.3-1.subtitle': '潮汐反転', 'stage.3-2.subtitle': '逆潮の階段', 'stage.3-3.subtitle': '鏡の海流',
  'stage.3-4.subtitle': '真珠の渦', 'stage.3-5.subtitle': '深淵海流', 'stage.3-6.subtitle': 'リヴァイアサンの鏡',
  'stage.4-1.subtitle': '氷縛の疾走', 'stage.4-2.subtitle': '水晶斜面', 'stage.4-3.subtitle': '霜の連鎖',
  'stage.4-4.subtitle': '吹雪リフト', 'stage.4-5.subtitle': '凍結試練', 'stage.4-6.subtitle': '雪冠の決闘',
  'stage.5-1.subtitle': '燃え殻の疾走', 'stage.5-2.subtitle': 'マグマリフト', 'stage.5-3.subtitle': '噴火連鎖',
  'stage.5-4.subtitle': 'カルデラ横断', 'stage.5-5.subtitle': '業火試練', 'stage.5-6.subtitle': '熾心の決闘',
  'stage.6-1.subtitle': '虚ろの境界', 'stage.6-2.subtitle': '反転する棘', 'stage.6-3.subtitle': '深淵コンベア',
  'stage.6-4.subtitle': '魔流', 'stage.6-5.subtitle': '最終融合', 'stage.6-6.subtitle': '深淵女王の決闘',
  'stage.objective.reachGoal': 'ゴールへ到達', 'stage.objective.defeatBoss': 'ボスを倒す',
  ...
  'hud.jump': 'ジャンプ', 'hud.crouch': 'しゃがむ', 'hud.attack': '攻撃', 'hud.homing': 'ホーミング', 'hud.navigator': '宮殿ナビゲーター',
  'hud.bossPhase': 'ボスフェーズ', 'hud.bossPhaseHint': '攻撃が当たるたび入口から次のパターンが始まります。', 'hud.time': 'タイム',
...
const zhTW: Dictionary = {
  ...
  'stage.1-5.subtitle': '空中花園', 'stage.1-6.subtitle': '高塔', 'stage.2-1.subtitle': '刺醒階梯',
  'stage.2-2.subtitle': '藤蔓渡台', 'stage.2-3.subtitle': '荊棘奔路', 'stage.2-4.subtitle': '樹冠升降',
  'stage.2-5.subtitle': '聖林試煉', 'stage.2-6.subtitle': '心根決鬥',
  'stage.3-1.subtitle': '潮汐反轉', 'stage.3-2.subtitle': '逆潮階梯', 'stage.3-3.subtitle': '鏡流',
  'stage.3-4.subtitle': '珍珠渦流', 'stage.3-5.subtitle': '深淵洋流', 'stage.3-6.subtitle': '海龍鏡界',
  'stage.4-1.subtitle': '冰封奔路', 'stage.4-2.subtitle': '水晶斜坡', 'stage.4-3.subtitle': '霜鏈',
  'stage.4-4.subtitle': '暴雪升降', 'stage.4-5.subtitle': '冰封試煉', 'stage.4-6.subtitle': '雪冠決鬥',
  'stage.5-1.subtitle': '燼火奔路', 'stage.5-2.subtitle': '熔岩升降', 'stage.5-3.subtitle': '噴發連鎖',
  'stage.5-4.subtitle': '火山口橫越', 'stage.5-5.subtitle': '煉獄試煉', 'stage.5-6.subtitle': '燼心決鬥',
  'stage.6-1.subtitle': '魔窟門檻', 'stage.6-2.subtitle': '反轉荊棘', 'stage.6-3.subtitle': '深淵輸送',
  'stage.6-4.subtitle': '惡魔流域', 'stage.6-5.subtitle': '最終綜合', 'stage.6-6.subtitle': '深淵女王決鬥',
  'stage.objective.reachGoal': '抵達終點', 'stage.objective.defeatBoss': '擊敗 Boss',
  ...
  'hud.jump': '跳躍', 'hud.crouch': '蹲下', 'hud.attack': '攻擊', 'hud.homing': '追蹤攻擊', 'hud.navigator': '宮殿導航 AI',
  'hud.bossPhase': 'Boss 階段', 'hud.bossPhaseHint': '每次命中後會回到入口，並進入下一段彈幕。', 'hud.time': '時間',
...
const ko: Dictionary = {
  ...
  'stage.1-5.subtitle': '공중 정원', 'stage.1-6.subtitle': '높은 첨탑', 'stage.2-1.subtitle': '가시 깨어난 계단',
  'stage.2-2.subtitle': '덩굴 나룻길', 'stage.2-3.subtitle': '가시덤불 질주', 'stage.2-4.subtitle': '수관 승강대',
  'stage.2-5.subtitle': '성역 시련', 'stage.2-6.subtitle': '심근 결투',
  'stage.3-1.subtitle': '조수 반전', 'stage.3-2.subtitle': '역조 계단', 'stage.3-3.subtitle': '거울 해류',
  'stage.3-4.subtitle': '진주 소용돌이', 'stage.3-5.subtitle': '심연 해류', 'stage.3-6.subtitle': '레비아탄 거울',
  'stage.4-1.subtitle': '얼음 질주', 'stage.4-2.subtitle': '수정 비탈', 'stage.4-3.subtitle': '서리 연쇄',
  'stage.4-4.subtitle': '눈보라 승강대', 'stage.4-5.subtitle': '결빙 시련', 'stage.4-6.subtitle': '설관 결투',
  'stage.5-1.subtitle': '잿불 질주', 'stage.5-2.subtitle': '마그마 승강대', 'stage.5-3.subtitle': '분화 연쇄',
  'stage.5-4.subtitle': '칼데라 횡단', 'stage.5-5.subtitle': '연옥 시련', 'stage.5-6.subtitle': '불씨 결투',
  'stage.6-1.subtitle': '공허의 문턱', 'stage.6-2.subtitle': '반전 가시', 'stage.6-3.subtitle': '심연 컨베이어',
  'stage.6-4.subtitle': '악마 해류', 'stage.6-5.subtitle': '최종 종합', 'stage.6-6.subtitle': '심연 여왕 결투',
  'stage.objective.reachGoal': '목표 지점에 도달', 'stage.objective.defeatBoss': '보스 처치',
  ...
  'hud.jump': '점프', 'hud.crouch': '앉기', 'hud.attack': '공격', 'hud.homing': '호밍', 'hud.navigator': '궁전 내비게이터',
  'hud.bossPhase': '보스 페이즈', 'hud.bossPhaseHint': '한 번 맞힐 때마다 입구에서 다음 패턴이 시작됩니다.', 'hud.time': '시간',
